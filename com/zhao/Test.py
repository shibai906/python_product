...
#pos = 0
# 根目录
withDirectory = '/home/java-tron/hulin/syslog-monitor/codelab/'
...
#  print(filePath)
  ...
  wm.add_watch(withDirectory, pyinotify.ALL_EVENTS, rec=True, auto_add=True)
...
def main():
  for i, j, k in os.walk(withDirectory):
    for g in k:
